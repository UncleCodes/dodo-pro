 ...
 * @version v 1.0
 */
public class DynamicModuleQueryResult {
	private List<DynamicModuleQueryField> queryFields;
	...
	public List<DynamicModuleQueryField> getQueryFields() {
		return queryFields;
	}
	public List<List<String>> getQueryDatas() {
		return queryDatas;
	}
	public void setQueryFields(List<DynamicModuleQueryField> queryFields) {
