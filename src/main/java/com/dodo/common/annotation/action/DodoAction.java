...
public enum DodoAction {
	...
	VIEW(new DodoActionType[]{DodoActionType.LIST,DodoActionType.VIEW,DodoActionType.TOPOPUP,DodoActionType.POPUPLIST}),
	...
	CHART(new DodoActionType[]{DodoActionType.TOCHART,DodoActionType.CHARTLIST,DodoActionType.CHART/*,DodoActionType.CHARTEXPORT*/}),
