...
public class ModuleField extends BaseEntity {
    ...
    @DodoField(sortSeq = 4, nameKey = "dodo.privilege.dynmodule.config.ModuleField.namekey.queryType")
    private ReportQueryType   queryType;

    @DodoField(sortSeq = 5, nameKey = "dodo.privilege.dynmodule.config.ModuleField.namekey.isShow", isnullable = false)
