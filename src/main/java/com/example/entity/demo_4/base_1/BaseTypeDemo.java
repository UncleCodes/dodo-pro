...
import com.dodo.common.annotation.field.DodoExtAttr;
...
public class BaseTypeDemo extends BaseEntity {
    ...
    @DodoField(
            ...
            maxFileSize = 1,
            infoTip = "我是一个测试的测试提示信息，最大1M")
    private String            imageField;

    @DodoField(
            sortSeq = 21,
            name = "单文件类型字段（限制ZIP），最大1M",
            isFile = true,
            fileStyle = FileStyle.OnlyPath,
    ...
    @DodoField(
            ...
            isMultiFile = true,
            maxFileSize = 1,
            extAttr = { @DodoExtAttr(attrKey = "attr1", attrLabel = "测试属性1"),
            @DodoExtAttr(attrKey = "attr2", attrLabel = "测试属性2"), @DodoExtAttr(attrKey = "attr3", attrLabel = "测试属性3") })
    private String            multiZipField;

    @DodoField(sortSeq = 23, name = "文档字段", isDoc = true, fileType = { @DodoFileType(
            title = "文档文件",
            extensions = "xls,xlsx,doc,docx,pdf,ppt,pptx") }, infoTip = "最大1M", maxFileSize = 1, extAttr = {
            @DodoExtAttr(attrKey = "docattr1", attrLabel = "测试文档属性1"),
            @DodoExtAttr(attrKey = "docattr2", attrLabel = "测试文档属性2"),
            @DodoExtAttr(attrKey = "docattr3", attrLabel = "测试文档属性3") })
    ...
    @DodoField(
            ...
            maxFileSize = 15,
            infoTip = "最大15M",
            fileType = { @DodoFileType(title = "视频文件", extensions = "mp4,avi,rm,rmvb,wmv") })
    ...
    @DodoField(sortSeq = 27, name = "地理位置类型字段", isLocation = true, extAttr = {
            @DodoExtAttr(attrKey = "lbsattr1", attrLabel = "测试地址属性1"),
            @DodoExtAttr(attrKey = "lbsattr2", attrLabel = "测试地址属性2"),
            @DodoExtAttr(attrKey = "lbsattr3", attrLabel = "测试地址属性3") })
